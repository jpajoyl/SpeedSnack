...
<body id="page-top">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          <form name="form-suscripcion" id="form-suscripcion" novalidate="novalidate">
            ...
            <div id="success"></div>
            <div class="form-group">
              <button type="submit" class="btn btn-primary btn-xl" id="sendMessageButton">Registrar suscripcion</button>
            </div>
          </form>
        </div>
      </div>
  ...
  <section id="table-info">
    ...
    <div class="container-small">
      <h3 class="text-center text-uppercase text-secondary mb-0">SUSCRIPCIONES REGISTRADOS</h3>
      <div class="row mt-4">
        <div class="col-lg-12">
          <table class="table table-bordered table-hover">
            <thead class="thead-light">
  ...
  <section id="busquedas">
    <div class="container-small">
      ...
      <div class="row" id="row-busquedas">
        <div class="col-lg-6" id="container-form-usuario">
          <center>
            <h4>El usuario_login de un usuario y se deben mostrar todas las suscripciones a las cuales el usuario está suscrito(o sea, de los cuales el usuario es seguidor).</h4>
