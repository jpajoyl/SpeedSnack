...
ALTER TABLE COMPRA ADD FOREIGN KEY (usuario_login_vendedor) REFERENCES USUARIO(usuario_login) ON DELETE CASCADE;

ALTER TABLE COMPRA ADD FOREIGN KEY (usuario_login_comprador) REFERENCES USUARIO(usuario_login) ON DELETE CASCADE;
...
ALTER TABLE SUBSCRIPCION ADD FOREIGN KEY (usuario_login_seguido) REFERENCES USUARIO(usuario_login) ON DELETE CASCADE;

ALTER TABLE SUBSCRIPCION ADD FOREIGN KEY (usuario_login_seguidor) REFERENCES USUARIO(usuario_login) ON DELETE CASCADE;
...
ALTER TABLE PUNTO_DE_VENTA ADD CONSTRAINT `fk_usuario_login_punto_de_venta`
...
ALTER TABLE PUNTO_DE_VENTA ADD CONSTRAINT `fk_usuario_login_domiciliario`
			FOREIGN KEY(`usuario_login`) REFERENCES `SpeedSnack`.`USUARIO` (`usuario_login`) ON DELETE CASCADE;
...
ALTER TABLE INVENTARIOxPRODUCTOxVENDEDOR ADD FOREIGN KEY (`usuario_login`) REFERENCES USUARIO(usuario_login) ON DELETE CASCADE;
ALTER TABLE INVENTARIOxPRODUCTOxVENDEDOR ADD FOREIGN KEY (`codigo_producto`) REFERENCES PRODUCTO(codigo_producto) ON DELETE CASCADE;
...
ALTER TABLE ARTICULO_POR_COMPRA ADD CONSTRAINT `fk_usuario_login_codigo_producto`
...
ALTER TABLE ARTICULO_POR_COMPRA ADD CONSTRAINT `fk_codigo`
			FOREIGN KEY(`codigo`)
